...
\begin{document}  % Begin the document
	...
	Another relevant review was published by \cite{alahmadi2022comparative}. In their work, the authors focused specifically on blockchains and its application in the digital transformation of ports and shipping. The research is presented as a review article, rather than a proper SLR, and has particular focus on the supply chain. Again, an holistic view of digital transformation on the shipping industry was not the goal of this research and is therefore missing.
